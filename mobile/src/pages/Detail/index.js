...
export default function Details(){
    ...
    function sendWhatsapp(){
        Linking.openURL(`whastapp://send?phone=${incident.whatsapp},text=${message} `);
    }
    ...
    <Text style={styles.incidentValue}>{incident.name} de {incident.city}/{incident.uf}</Text>
            ...
            <View style={styles.contacBox}>
                ...
                <View style={styles.actions}>
                    <TouchableOpacity sytle={styles.action} onPress={sendWhatsapp}>
                        <Text style={styles.actionText}>Whatsapp</Text>
                    </TouchableOpacity>
                    <TouchableOpacity sytle={styles.action} onPress={endMail}>
